...
//    self.tableView.dataSource = self;
    ...
    UIView *bgView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, self.view.bounds.size.width)];
    
    self.imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 64, bgView.bounds.size.width, bgView.bounds.size.height -10*2)];
...
//        [weakSelf presentViewController:picker animated:YES completion:nil];
        ...
        CameraVC.imageblock = ^(UIImage *kaimage) {
            weakSelf.imageView.image = kaimage;
        };
...
//        self.tableView.tableFooterView = [[UIView alloc] init];
    ...
    label.text = content;
    label.frame = CGRectMake(0, self.view.bounds.size.width+64, self.view.bounds.size.width, 0);
    [label sizeToFit];
