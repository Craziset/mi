...
- (void)resetCropView {
    ...
    self.frame = CGRectMake(CGRectGetMinX(self.arrow1.frame), CGRectGetMinY(self.arrow1.frame), CGRectGetMaxX(self.arrow2.frame) - CGRectGetMinX(self.arrow1.frame), CGRectGetMaxY(self.arrow3.frame) - CGRectGetMinY(self.arrow1.frame));
