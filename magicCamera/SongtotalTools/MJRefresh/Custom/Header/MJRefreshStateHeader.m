...
- (void)setLastUpdatedTimeKey:(NSString *)lastUpdatedTimeKey
{
    ...
    if (lastUpdatedTime) {
        ...
        time = [time stringByReplacingOccurrencesOfString:@"今天" withString:@"今天"];
        // 3.显示日期
        self.lastUpdatedTimeLabel.text = [NSString stringWithFormat:@"%@ %@",@"最后更新时间:",time];
...
- (void)prepare
{
    ...
    [self setTitle:@"松开后立即刷新" forState:MJRefreshStateIdle];
    [self setTitle:@"松开后立即刷新" forState:MJRefreshStatePulling];
