...
#import "songOderViewController4.h"
...
@interface songOderViewController4 ()<UITableViewDelegate,UITableViewDataSource>{
    int ToalPage;
    int page;
}
...
@implementation songOderViewController4
...
-(void)Requst:(int)tag{
    ...
    [afnObject POST:API_OrderUnsign parameters:dicPar success:^(id responseObject) {
